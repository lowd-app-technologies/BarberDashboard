...
const CompletedServicesPage = () => {
  ...
  if (loadingServices || loadingBarbers || loadingServiceOptions || loadingClients) {
    return (
      <div className="flex">
        <Sidebar />
                    ...
                    >
                      ...
                      <SelectContent>
                        {barbers.length > 0 ? barbers.map((barber: any) => (
                          ...
                          <SelectItem value="0">Nenhum barbeiro encontrado</SelectItem>
                        )}
                      </SelectContent>
                    </Select>
                  </div>
                    ...
                    >
                      ...
                      <SelectContent>
                        {services.length > 0 ? services.map((service: any) => (
                          ...
                          <SelectItem value="0">Nenhum serviço encontrado</SelectItem>
                        )}
                      </SelectContent>
                    </Select>
                  </div>
                ...
                <div className="grid grid-cols-4 items-center gap-4">
                  ...
                  <div className="col-span-3">
                    <Select
                      ...
                      onValueChange={(value) => setNewService(prev => ({ ...prev, clientName: value }))}
                    >
                      <SelectTrigger>
